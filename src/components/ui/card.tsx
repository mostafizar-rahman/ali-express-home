...
const Card = () => {
  return (
    <div className="relative rounded-2xl group">
      <div className="h-[378px] group-hover:absolute -left-[5%] z-40 group-hover:h-auto group-hover:shadow-4xl group-hover:rounded-2xl group-hover:w-[110%] py-4 bg-background">
        <div className="max-w-[256px] mx-auto">
          ...
          <div className="mt-2">
            ...
            <div className="mt-2.5 hidden group-hover:flex justify-between items-center gap-2 bg-background">
