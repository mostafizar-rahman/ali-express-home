...
const TodayDealsSecondPart = () => {
    return (
        <div className="container mt-8">
            <div className="bg-[url('/images/today-sect-bg.jpg')] bg-cover bg-no-repeat p-12">
                <div className="flex justify-between">
                    <div>
                        ...
                        <Button asChild size={"sm"} className="rounded-none text-xl font-medium mt-6">
                    ...
                    <div className="text-white grid grid-cols-2 gap-6">
                        <div className="w-[268px] flex items-center gap-2">
                            ...
                            <div>
                                <span className="text-[32px] font-bold block leading-none">5M+</span>
                        ...
                        <div className="w-[268px] flex items-center gap-2">
                            <div className="bg-[hsla(0,0%,100%,.6)] w-1 h-[54px]"></div>
                            <div>
                                <span className="text-[32px] font-bold block leading-none">20M+</span>
                        ...
                        <div className="w-[268px] flex items-center gap-2">
                            <div className="bg-[hsla(0,0%,100%,.6)] w-1 h-[54px]"></div>
                            <div>
                                <span className="text-[32px] font-bold block leading-none">10</span>
                        ...
                        <div className="w-[268px] flex items-center gap-2">
                            <div className="bg-[hsla(0,0%,100%,.6)] w-1 h-[54px]"></div>
                            <div>
                                <span className="text-[32px] font-bold block leading-none">24H</span>
                ...
                <div className="grid grid-cols-3 gap-[35px] mt-12">
                    <div className="bg-background px-8 py-4">
                        <b className="text-2xl text-center block">Buy in bulk</b>
                    ...
                    <div className="bg-background px-8 py-4">
                        <b className="text-2xl text-center block">Fast delivery</b>
                        <div className="mt-4 grid grid-cols-2 gap-[30px]">
                    ...
                    <div className="bg-background px-8 py-4">
                        <b className="text-2xl text-center block">Buy again</b>
                        <div className="mt-4 grid grid-cols-2 gap-[30px]">
...
const Card = ({ thumbnail, price, shortInfo }: CardPropsType) => {
    return (
        <div className="hover:scale-[1.03] transition-all duration-300">
            ...
            <div>
                <p className="text-xl font-bold inline-block">US ${price}</p>
